...
# devtools::install_github("mmollina/SIMpoly")
# install.packages("mappoly2")  # or devtools::install_github("mmollina/mappoly")
...
n_offspring <- c(200, 100, 200, 100, 300, 546, 199)
...
n_mrk <- 200  # Number of markers per chromosome

# Simulate genetic data
result <- simulate_multiparental_data(n.chr, map.len, pedigree, ploidy.vec, n_mrk, alleles)

# Extract results
wide_df <- result$wide_df
all_dat <- result$dat
parent_homologs <- result$parent_homologs
